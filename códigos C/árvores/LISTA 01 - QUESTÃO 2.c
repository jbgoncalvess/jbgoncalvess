/* 2. Escreva uma função que receba como parâmetro um ponteiro para a raiz de uma árvore binária e um valor inteiro
indicando um nível, e retorne o número de nós deste nível na árvore.*/
...
///FUNÇÃO QUE RECEBE UMA ARVÓRE E O VALOR PARA UM NÍVEL, E DIZ QUANTOS NÓS EXISTEM NAQUELE NÍVEL///
