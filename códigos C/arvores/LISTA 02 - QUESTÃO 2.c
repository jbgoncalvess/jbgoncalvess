/*2. Escreva uma função que receba como parâmetro um ponteiro para a raiz de uma árvore binária
e um valor inteiro g (cujos valores possíveis são 0, 1 ou 2), e retorne o número de nós da árvore que têm grau igual a g.*/
...
///FUNÇÃO QUE RECEBE UM PONTEIRO PARA UMA ARVORE BINARIA E UM VALOR X (0, 1 E 2), E RETORNA O NUMERO DE ELEMENTOS COM AQUELE GRAU///
